...
class enterpriseanim extends StatefulWidget {
  enterpriseanim({
    Key? key,
  }) : super(key: key);

  _enterpriseanimState createState() => _enterpriseanimState();
}
...
class _enterpriseanimState extends State<enterpriseanim>
